  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar:
            AppBar(backgroundColor: R.colors.white, elevation: 0, centerTitle: true, automaticallyImplyLeading: false, title: const Text("Cookly")),
        body: Container(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: R.textStyles.poppinsMedium(fontWeight: FontWeight.bold, fontSize: 16.sp),
