          ...
          return Column(
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xff202E28), borderRadius: BorderRadius.circular(10)),
                child: Row(
                  children: <Widget>[
          ...
          return Column(
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFFE6532D), borderRadius: BorderRadius.circular(10)),
                child: Row(
                  children: <Widget>[
                    ...
                    Flexible(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Text(LocalizationMap.getValue("oops"), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const SizedBox(height: 8),
                          Text(
                            LocalizationMap.getValue("something_went_wrong"),
                            style: const TextStyle(color: Colors.white),
                          ),
                        ],
                      ),
